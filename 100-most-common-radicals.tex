...
\newcommand{\rad}[2]{\href{http://www.archchinese.com/chinese_english_dictionary.html?find=#1}{#2}}

\newcommand*{\foo}{}

\newcommand*{\lnk}[1]{%\renewcommand{\foo}{#1}%
...
\newcolumntype{Y}{>{\large\collectcell\lnk}c<{\endcollectcell}}
